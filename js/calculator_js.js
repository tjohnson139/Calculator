...
const Calculator = {
    //this displays 0 in the screen
    Display_Value: '0',
    //this will hold the first oprand for any expression. We set it null for now
    First_Operand: null,
...
function Input_Digit(digit) {
    ...
    //we are cheking to see if Wait_Second_Operand is true and set
